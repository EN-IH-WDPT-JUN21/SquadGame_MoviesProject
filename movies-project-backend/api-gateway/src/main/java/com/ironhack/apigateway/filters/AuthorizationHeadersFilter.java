package com.ironhack.apigateway.filters;
...
@Component
public class AuthorizationHeadersFilter extends AbstractGatewayFilterFactory<AuthorizationHeadersFilter.Config> {


    private final Environment environment;

    public AuthorizationHeadersFilter(Environment environment) {
